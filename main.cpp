...
int main() {
   ...
   //Variable  
    ...
    if (ingresa == false){
        ...
        switch (opcion){
            ...
            case 4:
                ...
                //Estructura if para evitar egresos con dinero que no se tenga.
            ...
            case 5:
                ...
                //Estructura if para evitar tranferencias con dinero que no se tenga.
            ...
            default:
                ...
                //En caso de que el usuario ponga un numero que no se tenga 
    ...
    }while (opcion != 6); //Condicion del Do While 
